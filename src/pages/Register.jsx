...
const getRegistrationErrorMessage = (error) => {
	...
	return messages[error.code] || "We could not create your account. Please try again.";
};
...
function Register() {
	...
	const handleSubmit = async (event) => {
		...
		try {
			const result = await signup(email, form.password);
			...
			toast.error(getRegistrationErrorMessage(registrationError));
		} finally {
			setIsLoading(false);
		}
	};
		...
		<main style={styles.page}>
			<section style={styles.card}>
				<div style={styles.heading}>
					...
					<p style={styles.subtitle}>Create an account to continue shopping.</p>
				</div>
